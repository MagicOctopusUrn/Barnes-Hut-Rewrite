public class BHTree {
	...
	// Create and initialize a new bhtree. Initially, all nodes are null and will be
	// filled by recursion
	// Each BHTree represents a quadrant and a body that represents all bodies
	// inside the quadrant
	...
	// If all nodes of the BHTree are null, then the quadrant represents a single
	// body and it is "external"
	...
	// Until either we reach an external node or we reach a node that is
	// sufficiently
